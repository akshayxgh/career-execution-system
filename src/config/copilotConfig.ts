export const COPILOT_CONFIG = {
  ...
  model: import.meta.env.VITE_OPENROUTER_MODEL || import.meta.env.VITE_GEMINI_MODEL || (import.meta.env.VITE_OPENROUTER_API_KEY ? "google/gemini-2.0-flash-exp:free" : "gemini-2.0-flash"),
  timeoutMs: 30000,
};
